...
public class AWToolsFileUtils {
    ...
    public static final Pattern WINDOWS_ROOT_PATTERN = Pattern
            .compile("^[a-zA-Z]:");
    ...
    public static InputStream classpathLoader(final String resource) {
        return AWToolsFileUtils.class.getClassLoader()
    ...
    public static String pathToRoot(final String fileName) {
        return AWToolsFileUtils
                .pathToRoot(AWToolsFileUtils.countDirLevel(fileName));
    }
    ...
    public static String normalizePath(final String fileName) {
        ...
        String newFileName = StringUtils.replace(fileName, "\\",
                WINFILE_SEPERATOR);
