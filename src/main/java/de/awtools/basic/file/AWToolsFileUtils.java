...
public class AWToolsFileUtils {
	 ...
	 *            Das Verzeichnis.
	 * @param fileName
	 *            Die Datei relativ zu dem Verzeichnis.
	...
	/**
	 * Erzeugt die nötigen Verzeichnisse unterhalb von <code>basePath</code> um
	 * eine Datei <code>relativeFileName</code> anlegen zu können. Die Datei
	 ...
	 * z.B. C:/tmp/www/web.xml nicht als Verzeichnis angelegt. Im Beispiel wäre
	 * <code>web.xml</code> tatsächlich als Verzeichnis angelegt worden.
	 *
	 * @param basePath
	 *            Ein Basisverzeichnis.
	 * @param relativeFileName
	 *            Ein relativer Filename (ab Basis).
	 */
	public static void createFilePath(final String basePath, final String relativeFileName) {
	...
	/**
	 * Unterstützt die {@link #createFilePath(String, String)} bei ihrer Arbeit.
	 *
	 * @param basePath
	 *            Ein Basisverzeichnis.
	 * @param relativeFileName
	 *            Ein relativer Filename (ab Basis).
	 * @param separator
	 *            Der Separator für Verzeichnisse.
	 */
	private static void createFilePath(final String basePath, final String relativeFileName, final char separator) {
	...
	/**
	 * Berechnet die Anzahl der Verzeichnisstufen bis zum gesuchten Dateinamen.
	 * Die Angabe kann fiktiv sein, d.h. mussen nicht notwendiger Weise im
	 * Dateisystem vorliegen. Z.B. Der Parameter "./www/dir/dir1/index.html"
	 * liefert 3 zurück.
	 *
	 * @param fileName
	 *            Die gesuchte Datei.
	...
	/**
	 * Sucht nach allen Dateien, die auf einem Verzeichnispfad liegen und die
	 * die Bezeichnung 'fileName' besitzen. Der vorgegebene Verzeichnistrenner
	 * ist der '/'. Beispiel:<br/>
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * 
	 * Gesucht wird der <code>fileName = readme.txt</code>, der zu untersuchende
	 * Pfadabschnitt lautet <code>dir11/dir121/</code> und
	 * <code>basePath = /temp</code>, dann wird folgende Liste zurück geliefert:
	 * <code>/temp/readme.txt</code>, <code>/temp/dir1/readme.txt</code>,
	 * <code>/temp/dir1/dir121/readme.txt</code>.
	 *
	 * @param basePath
	 *            Basisverzeichnis.
	 * @param relativePath
	 *            Der relative Pfad - zum Basisverzeichnis - zu der gesuchten
	 *            Datei.
	 * @param fileName
	 *            Die gesuchte Datei.
	 * @return Eine Liste der Dateien, die den selben Dateibezeichner haben wie
	 *         im <code>fileName</code> und auf dem Pfad zwischen
	 *         Basisverzeichnis und der gesuchten Datei liegen.
	 */
	public static List<File> findFiles(final File basePath, final String relativePath, final String fileName) {
	 ...
	 *
	 * @param fileName
	 *            Der zu normalisierende Dateiname.
	 ...
	 *
	 * @param fileName
	 *            Der Dateibezeichner dessen Verzeichnispfad ermittelt werden
	 *            soll.
	 ...
	 * 
	 * @param fileName
	 *            Der zu untersuchende Dateibezeichner.
