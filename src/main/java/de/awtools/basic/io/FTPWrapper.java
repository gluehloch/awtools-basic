...
public class FTPWrapper {
	 ...
	 *             Da ging was schief.
	 */
	public boolean connectAndLogin(final String host, final String userName, final String password)
	...
	public boolean downloadFile(final String serverFile, final String localFile)
		...
		try (FileOutputStream out = new FileOutputStream(localFile)) {
			...
			log.info("Downloading file ->{}<- to local file ->{}<-.", serverFile, localFile);
	 ...
	 * @since 1.6
	 */
	public boolean changeWorkingDirectory(final String directoryName) throws IOException {
	 ...
	 *
	 * @param directoryName
	 *            Der Name des anzulegenden Verzeichnisses.
	 * @throws IOException
	 *             Da ging was schief.
	 *
	 * @since 1.6
	 ...
	 * @since 1.6
	 */
	public void changeOrCreateDirectory(final String rootDirectory, final String directory) throws IOException {
