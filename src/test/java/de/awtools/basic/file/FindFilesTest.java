...
public class FindFilesTest {
    ...
    public void testFindFilesTwoParams() throws Exception {
        ...
        List<File> files = AWToolsFileUtils.findFiles(
                new File(tempDir.toString()), "test/winkler/arbeit/findmy.txt");
        ...
        files = AWToolsFileUtils.findFiles(new File(tempDir.toString()),
                "findmy.txt");
    ...
    public void testFindFiles() throws Exception {
        ...
        if (log.isDebugEnabled()) {
            log.debug(
                    "WinFileUtils.findFiles('{}', 'test/winkler/arbeit', 'findmy.txt'",
                    tempDir);
        }

        List<File> files = AWToolsFileUtils.findFiles(
                new File(tempDir.toString()), "test/winkler/arbeit",
                "findmy.txt");
