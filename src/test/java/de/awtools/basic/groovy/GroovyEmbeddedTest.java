/*
 * $Id: GroovyEmbeddedTest.java 3725 2013-05-24 18:34:57Z andrewinkler $
 * ============================================================================
...
public class GroovyEmbeddedTest {
    ...
    public void testStartGroovyEmbeddedCompileScript() throws Exception {
        GroovyScriptEngine engine =
                new GroovyScriptEngine("src/test/resources", this.getClass()
                    .getClassLoader());

        engine.run("de/awtools/basic/groovy/Operator.groovy", new Binding());

        Class<?> clazz =
                engine.loadScriptByName("de/awtools/basic/groovy/Operator.groovy");
    ...
    public void testGroovyClassLoader_new() throws Exception {
        ...
        InputStream is =
                this.getClass().getResourceAsStream("/Operator2.groov");
        assertThat(is).isNotNull();
        // Diese Variante funktioniert nicht aus Eclipse heraus. Die Groovy Dateien
        // landen in ein anderes Verzeichnis, welches nicht im Klassenpfad liegt.
        //        InputStream is = this.getClass().getResourceAsStream("/Operator2.groovy");
        //        assertNotNull(is);
        ...
        GroovyCodeSource gcs =
                new GroovyCodeSource(isr, "i dont´t know", "unknown");
