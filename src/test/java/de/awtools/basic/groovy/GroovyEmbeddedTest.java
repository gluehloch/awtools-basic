...
public class GroovyEmbeddedTest {
	...
	public void testStartGroovyEmbeddedCompileScript() throws Exception {
		GroovyScriptEngine engine = new GroovyScriptEngine("src/test/resources", this.getClass().getClassLoader());

		engine.run("de/awtools/basic/groovy/Operator.groovy", new Binding());

		Class<?> clazz = engine.loadScriptByName("de/awtools/basic/groovy/Operator.groovy");
	...
	public void testGroovyClassLoader_new() throws Exception {
		...
		InputStream is = this.getClass().getResourceAsStream("/Operator2.groov");
		...
		GroovyCodeSource gcs = new GroovyCodeSource(isr, "i dont´t know", "unknown");
